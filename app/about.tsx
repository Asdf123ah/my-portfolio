        ...
        <div className="w-[72%] text-center">
          ...
          <div className="flex items-center justify-center">
            ...
            <motion.div
              ...
              className="border-4 h-[180px] md:h-[280px] lg:h-[380px] xl:h-[480px] 2xl:h-[580px] 3xl:h-[680px] border-[#676F75] mx-4 md:mx-8 lg:mx-12 xl:mx-16 2xl:mx-20 3xl:mx-24 mt-20"
            ></motion.div>
            <div className="">
              <motion.h1
                ref={ref}
